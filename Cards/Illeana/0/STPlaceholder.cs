...
/// </summary>
public class SnekTunezPlaceholder : Card, IRegisterable
{
    public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
    {
        helper.Content.Cards.RegisterCard(new CardConfiguration
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "Token", "SnekTunezPlaceholder", "name"]).Localize,
        });
    }
    ...
    public override List<CardAction> GetActions(State s, Combat c)
    {
        ...
        return upgrade switch
        {
            ...
            [
                ...
                {
                    targetPlayer = true,
                    status = ModEntry.Instance.SnekTunezStatus.Status,
                    statusAmount = x,
                    xHint = 1
                },
                new AStunShip(),
