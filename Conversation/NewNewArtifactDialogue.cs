...
internal class NewNewArtifactDialogue : IRegisterable
{
    public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
    {
        LocalDB.DumpStoryToLocalLocale("en", new Dictionary<string, DialogueMachine>(){
            {"ArtifactShieldPrepIsGone_Illeana_0", new(){
            ...
            {"ArtifactWarpMastery_Illeana_0", new(){
                type = NodeType.combat,
                oncePerRun = true,
                allPresent = [ AmIlleana ],
            ...
            {"ArtifactJumperCablesUseless_Illeana", new(){
                type = NodeType.combat,
                oncePerRun = true,
                allPresent = [ AmIlleana ],
            ...
            {"ArtifactSimplicity_Illeana", new(){
                type = NodeType.combat,
                allPresent = [ AmIlleana ],
            ...
            {"ArtifactTiderunner_Illeana", new(){
                type = NodeType.combat,
                oncePerRun = true,
                turnStart = true,
                maxTurnsThisCombat = 1,
            ...
            {"ArtifactLightenedLoad_Illeana", new(){
                type = NodeType.combat,
                oncePerRun = true,
                allPresent = [ AmIlleana ],
        ...
        LocalDB.DumpStoryToLocalLocale("en", "Shockah.DuoArtifacts", new Dictionary<string, DialogueMachine>(){
            ...
            {"ArtifactAirlockAirlocked_Illeana", new(){
                type = NodeType.combat,
                oncePerRun = true,
            ...
            {"ArtifactSuperInjection_Illeana", new(){
                type = NodeType.combat,
                oncePerRun = true,
            ...
            {"ArtifactPerfectPerfect_Illeana", new(){
                type = NodeType.combat,
                oncePerRun = true,
            ...
            {"ArtifactHullHarvestor_Illeana", new(){
                type = NodeType.combat,
                oncePerRun = true,
